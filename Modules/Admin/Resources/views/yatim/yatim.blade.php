...
<section class="content-header">
    <!--section starts-->
<h1>@lang("admin::yatim.yatim")</h1>
<ol class="breadcrumb">
    <li><a href="/"><i class="fa fa-dashboard"></i>Dashboard</a></li>
    <li class="active"><a href="#">@lang("admin::yatim.yatim")</a></li>
</ol>
</section>
...
<section class="content">
  <div class="row">
    <div class="col-md-8">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">@lang("admin::yatim.yatim_list")</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
					<form method="post" id="formsatuan">
						<meta id="token" name="token" content="{{ csrf_token() }}">
          <table id="yatimtable" class="table table-bordered table-hover" style="width:100%">
            <thead>
            <tr>
              <th ></th>
    ...
    <div class="col-md-4">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" id="judulsatuan">@lang("admin::yatim.yatim_input")</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="container-fluid add-product">
          <form id="yatimform" enctype="multipart/form-data" action="{{ route('yatim-store') }}" method="post" data-toggle="validator">
              {{csrf_field()}}
              <input id="inputhidden" type='hidden' name='_method' value='POST'>
              <div class="row">
                <div class="form-group col-md-12">
                <label for="name" class=" control-label">@lang("admin::yatim.name") : </label>
              ...
              <div class="form-group col-md-12" id="leveldiv">
								<label for="gender">@lang('admin::yatim.gender')</label>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label for="birth">@lang('admin::yatim.birth') : </label>
              ...
              <div class="row">
              <div class="form-group col-md-12">
							<label for="telephone" class=" control-label">@lang('admin::yatim.telephone')</label>
              ...
              <div class="row">
              <div class="form-group col-md-12">
							<label for="address" class=" control-label">@lang('admin::yatim.address')</label>
              ...
              <div class="row">
						<div class="form-group col-md-12">
							<label for="city" class=" control-label">@lang('admin::yatim.city')</label>
              ...
              <div class="row">
						<div class="form-group col-md-12">
							<label for="country" class=" control-label">@lang('admin::yatim.country')</label>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                <label for="note" class=" control-label">@lang("admin::yatim.note") : </label>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <input id="submit" type="submit" class="form-control btn btn-primary prod-submit" value="@lang('admin::yatim.yatim_add')">
                </div>
              </div>
          </form>
          </div>
...
$('#yatimtable tbody').on('click', 'td.details-control', function () {
...
function editForm(id){
	  ...
	  $('#yatimform')[0].reset();
	  $.ajax({
	    url : "/admin/yatim/"+id+"/edit",
	    type : "GET",
	    dataType : "JSON",
	    success : function(data){
	      $('#judulsatuan').text('@lang("admin::yatim.yatim_edit")');
	      $('#submit').val('@lang("admin::yatim.yatim_edit")');
	      $('#name').val(data.name);
        ...
        $('#newpicture').remove();
			  $('#image_picture').append('<div class="form-group" id="newpicture">'+
	                                     '<img id="image_baru" src="'+data.full_picture_path+
	 																...
	 																'</div>');
	      $('#yatimform').attr('action', 'yatim/'+id);
	    },
	    error : function() {
