...
<section class="content-header">
    <!--section starts-->
<h1>@lang("admin::dev.donation")</h1>
<ol class="breadcrumb">
    <li><a href="/"><i class="fa fa-dashboard"></i>Dashboard</a></li>
    <li class="active"><a href="#">@lang("admin::dev.dev")</a></li>
</ol>
</section>
...
<section class="content">
  <div class="row">
        ...
        <div class="box-body">
          ...
          <table id="devtable" class="table table-bordered table-hover" style="width:100%">
            ...
            <tr>
              ...
              <th style="text-align:center">@lang("admin::dev.note")</th>
    ...
    <div class="col-md-4">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title" id="judulsatuan">@lang("admin::dev.dev_input")</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="container-fluid add-product">
          <form id="devform" action="{{ route('dev-store') }}" method="post" data-toggle="validator">
              {{csrf_field()}}
...
function editForm(id){
	  ...
	  $('#devform')[0].reset();
	  $.ajax({
	    url : "/admin/dev/"+id+"/edit",
	    type : "GET",
	    dataType : "JSON",
	    success : function(data){
	      $('#judulsatuan').text('@lang("admin::dev.dev_edit")');
	      $('#submit').val('@lang("admin::dev.dev_edit")');
	      $('#name').val(data.name);
        $('#note').val(data.note);
	      $('#devform').attr('action', 'dev/'+id);
	    },
	    error : function() {
